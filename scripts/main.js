const firstSemesterCourses = JSON.parse(localStorage.getItem('firstSemesterCourses')) || [];
const secondSemesterCourses = JSON.parse(localStorage.getItem('secondSemesterCourses')) || [];
